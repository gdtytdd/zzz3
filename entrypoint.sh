...
UUID=${UUID:-'d8416746-deb1-4145-8f74-23cd649f32dc'}
VMESS_WSPATH=${VMESS_WSPATH:-'/d8416746-deb1-4145-8f74-23cd649f32dc-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/d8416746-deb1-4145-8f74-23cd649f32dc-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/d8416746-deb1-4145-8f74-23cd649f32dc-trojan'}
